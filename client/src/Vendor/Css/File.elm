module Vendor.Css.File (compile, toFileStructure, CssFileStructure) where
...
import Vendor.Css exposing (Stylesheet)
import Vendor.Css.Declaration exposing (DeclarationTransform)
